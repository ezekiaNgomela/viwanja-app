const Components = {
    ...
    Footer: () => `
        <footer class="bg-white border-t border-slate-100 py-10 h-60 mt-10 text-center">
            ...
            <div class="flex justify-center items-center py-2 px-6>
               <h3 class="flex justify-center text-red items-center p-2 text-bold>tovuti hii imetengenezwa na delphinus mchunguzi||ezekia ak </h3>
